...
def split_ssl_data(file_name):
    base_dataset = mydataset('../data/gender')
    ...
    label = mydataset('../data/gender',index = index[2], noisy_label=noisy_label)
    u_label = mydataset('../data/gender',index = index[1])
    test = mydataset('../data/gender',index = index[3])
