...
class reProgrammingNetwork(nn.Module):
    def __init__(self,args, input_size=224, patch_H_size=192, patch_W_size=192, channel_out=3, device="cpu") -> None:
        ...
        # self.new_layers = nn.Sequential(nn.Linear(768, 10)) ## vit imaganet 21
        # self.new_layers = nn.Sequential(nn.Linear(21841, 1000), nn.Linear(1000, 10)) #swinv2_22k
        self.new_layers = nn.Sequential(nn.Linear(1000, 10))#swinv2_22k_ft_1k and convnextv2_ft_in22k_in1k and convnext_base_22k
...
def main():
    ...
    torch.save(teacher_preds_all, f"../teacher_preds/teacher_preds_cifar10.pth")  
