...
def split_ssl_data(file_name):
    base_dataset = mydataset('/root/autodl-tmp/Celeba_Hair/test')
    datasize = len(base_dataset)
    index = random_split([50000, datasize-53000, 2000, 1000],8872574)
    index = random_split([datasize-3000, 2000, 1000], 8872574)
    #8872574
    ...
    while i < len(noisy_label):
        if noisy_label[i] == -1:
            ...
            i -= 1
        i+=1
    # label = mydataset('/root/autodl-tmp/gender/',index = index[2])
    label = mydataset('/root/autodl-tmp/Celeba_Hair/test',index = index[1], noisy_label=noisy_label)
    u_label = mydataset('/root/autodl-tmp/Celeba_Hair/test',index = index[0])
    test = mydataset('/root/autodl-tmp/Celeba_Hair/test',index = index[2])
